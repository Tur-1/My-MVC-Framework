...
class ComposerAutoloaderInit427c8b7c03b4c416ee023fa53b836057
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit427c8b7c03b4c416ee023fa53b836057::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire427c8b7c03b4c416ee023fa53b836057($fileIdentifier, $file);
        }
...
function composerRequire427c8b7c03b4c416ee023fa53b836057($fileIdentifier, $file)
{
